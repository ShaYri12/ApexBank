  ...
  useEffect(() => {
    const handleResize = () => {
      if (window.innerWidth < 768) {
        // Adjust this breakpoint according to your medium device size
        setIsExpanded(false);
      } else {
        setIsExpanded(true);
      }
    ...
    <>
      ...
      >
        <div className="flex flex-col pt-[32px] text-[16px] gap-[24px]">
          ...
          <div
            className={`relative flex-1 px-[24px] md:grow-0 pt-[10px]  pb-[10px] pr[14px] ${
              isExpanded ? "" : "hidden"
            }`}
          >
            <img
          ...
          <nav
            className={`grid items-start px-2 gap-[20px] font-[600] text-textColor text-[16px] lg:px-[16px] ${
        ...
        <div
          className={`flex flex-col gap-[24px] ${isExpanded ? "" : "hidden"}`}
        >
